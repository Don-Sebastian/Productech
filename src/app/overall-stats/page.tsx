...
export default function OverallStatsPage() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-slate-950">
        ...
        <main className="ml-0 md:ml-64 p-4 md:p-8 text-slate-400">
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-slate-950">
        <Sidebar user={session.user} />
        <main className="ml-0 md:ml-64 p-4 md:p-8 text-red-400">
  ...
  if (!data?.overall) {
    return (
      <div className="min-h-screen bg-slate-950">
        <Sidebar user={session.user} />
        <main className="ml-0 md:ml-64 p-4 md:p-8 text-slate-400">
          No overall stats available. Do you own any companies?
        </main>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <main className="ml-0 md:ml-64 p-4 md:p-8">
        <div className="space-y-6 max-w-6xl mx-auto pb-24 animate-in fade-in zoom-in-95 duration-300">
