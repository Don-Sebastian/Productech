  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <main className="ml-64 p-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-1">Production Overview</h1>
          <p className="text-slate-400">Monitor all production batches across your company</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:ring-2 focus:ring-emerald-500/50 outline-none transition"
            />
          </div>
          <select
            value={statusFilter}
            onChange={(e) => setStatusFilter(e.target.value)}
            className="px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white focus:ring-2 focus:ring-emerald-500/50 outline-none transition"
          >
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            {filteredBatches.map((batch) => {
              ...
              return (
                <div key={batch.id} className="bg-slate-800/40 border border-slate-700/50 rounded-xl p-5 hover:border-slate-600/50 transition">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-400 text-sm">
                          {batch.productType?.name} • {batch.assignedTo?.name}
