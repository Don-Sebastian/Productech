    ...
    return (
        <div className="min-h-screen bg-slate-950">
            ...
            <main className="ml-0 md:ml-64 p-4 md:p-8 pb-24">
                ...
                {/* Glue Stock Card */}
                {glueStock && (
                    <div className={`mb-8 border rounded-2xl p-6 transition-all duration-300 ${glueStock.currentKg < glueThreshold
                                ...
                                {recentBatches.map((batch: any) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span
                                                className={`text-xs px-2.5 py-1 rounded-full ${batch.status === "COMPLETED"
